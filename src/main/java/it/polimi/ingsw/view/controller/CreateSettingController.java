...
public class CreateSettingController {
    ...
    public void easyButton(ActionEvent actionEvent) {
        View view = currentApplication.getClient().getView();
        view.setGamemode(GameMode.easy);
    }

    public void expertButton(ActionEvent actionEvent) {
        View view = currentApplication.getClient().getView();
        view.setGamemode(GameMode.expert);
    }

    public void twoPlayer(ActionEvent actionEvent) {
        View view = currentApplication.getClient().getView();
        view.setPlayerNumber(2);
    }

    public void threePlayer(ActionEvent actionEvent) {
        View view = currentApplication.getClient().getView();
